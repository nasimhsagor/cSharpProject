...
namespace RestaurantManagement
{
    public partial class Employee : Form
    {
        ...
        public Employee()
        {
            ...
            this.ManagerIdGenerate();
        }

        private void ManagerIdGenerate()
        {
        ...
        private void SalesmanIdGenerate()
        {
            this.Query = "select * from Employee order by Id desc";
            this.Ds = this.Da.ExecuteQuery(this.Query);
            ...
            string[] temp = previousId.Split('-');
            int serialNo = Convert.ToInt32(temp[1]);
            string nextId = "S-" + (++serialNo).ToString("000");
            this.txtId.Text = nextId;
        ...
        {
            if (this.cmbRole.Text == "salesman")
            {
                this.SalesmanIdGenerate();
