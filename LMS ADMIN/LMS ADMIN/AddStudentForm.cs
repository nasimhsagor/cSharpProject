...
namespace LMS_ADMIN
{
    public partial class AddStudentForm : Form
    {
        ...
        private void AddBtn_Click(object sender, EventArgs e)
        {
            ...
            string q = "INSERT INTO UserDatas(Name,Password,Email,UserRole,Gender) VALUES('" + NameBox.Text + "','" + PassBox.Text + "','" + EmailBox.Text + "'," + 2 + "," + gender.ToString() + ")";
            ...
            if (i > 0)
            {
                MessageBox.Show("Student-Profile Successfully Created.\n\nThank You", "Success");
                this.Close();
            }
            else
            {
